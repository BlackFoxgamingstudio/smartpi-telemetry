...
[![CI](https://github.com/BlackFoxgamingstudio/smartpi-telemetry/actions/workflows/ci.yml/badge.svg)](https://github.com/BlackFoxgamingstudio/smartpi-telemetry/actions/workflows/ci.yml)
...
| **REST Gateway** | ✅ Live on Port `8805` | `POST /api/v1/execute`, `GET /health` |
